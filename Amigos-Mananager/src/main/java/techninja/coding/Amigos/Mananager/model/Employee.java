package techninja.coding.Amigos.Mananager.model;
...
// Hot Tip #1
//Serializable helps allow this class to be saved in the DB as a DataStream


//Hot Tip #2
//Entity makes sure that this class is accurately mapped to any DB in the classpath
